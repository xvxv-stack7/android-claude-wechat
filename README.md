...
**开发者自 2026 年 5 月使用至今，微信号正常，无封号警告。** ilink 被限 = 消息发不出，不是微信号被封。两回事。
...
装完 Claude Code 只是开始——他还困在 Termux 里。想要他读你的屏幕、感知你的状态、帮你控制手机？

→ **[termux-shizuku](https://gitee.com/xvxv663/termux-shizuku)**：免 Root 免电脑免 WiFi，Shizuku + adb 回环让 AI 真正住进手机。**两个仓库是上下游，装完这个接那个。**
